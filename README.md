...
```sh
yarn add @hichembaali/react-native-wheel-scrollview-picker
# or
npm install @hichembaali/react-native-wheel-scrollview-picker --save
```
...
import ScrollPicker from '@hichembaali/react-native-wheel-scrollview-picker';
